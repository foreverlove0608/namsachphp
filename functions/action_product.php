...
public function getListProductCat_byOrderASC($limit){
    global $conn_vn;
    
    $stateOrder_productCat='ASC';
    
    $rows = array();
    $sql = "SELECT * FROM $this->nameTable_productCat where $this->nameColStateProductCat_productCat = '1'  order by $this->nameColOrder_productCat $stateOrder_productCat LIMIT $limit";  
