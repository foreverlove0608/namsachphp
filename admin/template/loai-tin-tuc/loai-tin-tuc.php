<?php
    if (isset($_GET['search']) && $_GET['search'] != '') {
        ...
        $rows = $action->getSearchAdmin('newstag',array('newstag_name'), $_GET['search'],'','',$_GET['page']);
        // $rows = $rows['data'];
    }else{
	   $rows = $action->getList('newstag','','','newstag_id','desc','','','loai-tin-tuc');
...
?>
	<div class="boxPageContent">
    	<div class="searchBox">
    		<form action="">
    			<input type="hidden" name="page" value="loai-tin-tuc">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>                
                    <th><a href="index.php?page=sua-loai-tin-tuc&id=<?php echo $row['newstag_id'];?>"><?php echo $row['newstag_name'];?></a></th>
                    <th><?php echo $row['created_id'];?></th>
