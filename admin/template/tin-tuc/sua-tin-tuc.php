...
?>
<?php 
    $newstag_arr = unserialize($row['newstag_arr']);
?>
                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_news_name'];?>" id="news_name_<?= $lang['languages_code']?>" name="lang[<?= $lang['languages_code']?>][lang_news_name]" onkeyup="news<?php echo $lang['languages_code'];?>()" />
                                        ...
                                        <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor1" name="lang[<?= $lang['languages_code']?>][lang_news_content]" ><?= $rowDetailLang['lang_news_content'];?></textarea></p>
...
<form action="" method="post" id="updateNews" enctype="multipart/form-data">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            <p class="titleRightNCP">Tiêu đề</p>
            <input type="text" class="txtNCP1" id="title" onchange="ChangeToSlug()" name="news_name" value="<?= $row_showMain['lang_news_name']?>"/>
            <p class="titleRightNCP">Mô tả ngắn:</p>
            <textarea class="longtxtNCP1" style="height:50px;" name="news_des"><?= $row_showMain['lang_news_des']?></textarea>
            <p class="titleRightNCP">Nội dung :</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor1" name="news_content"><?= $row_showMain['lang_news_content']?></textarea></p>
            <div class="rowNCP">
...
<script type="text/javascript">
    function newsvn () {
        ...
        title = document.getElementById("news_name_vn").value;
    ...
    function newsen () {
        ...
        //alert ("a");
        //Lấy text từ thẻ input title 
        title = document.getElementById("news_name_en").value;
        // document.getElementById('title_seo').value = title;
        //Đổi chữ hoa thành chữ thường
        slug = title.toLowerCase();
