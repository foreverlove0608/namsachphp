                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_newscat_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_newscat_name]" id="newscat_name_<?= $lang['languages_code']?>" onkeyup="newscat_<?= $lang['languages_code']?>()" />
...
<form action="" method="post" accept-charset="utf-8" id="updateNewsCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="number" name="newscat_sort_order" value="<?= $row['newscat_sort_order'] ?>">
        </div>
...
<script type="text/javascript">
    function newscat_vn () {
        ...
        title = document.getElementById("newscat_name_vn").value;
    ...
    function newscat_en () {
        ...
        //alert ("a");
        //Lấy text từ thẻ input title 
        title = document.getElementById("newscat_name_en").value;
        // document.getElementById('title_seo').value = title;
        //Đổi chữ hoa thành chữ thường
        slug = title.toLowerCase();
