                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" id="service_name_<?= $lang['languages_code']?>" value="<?= $rowDetailLang['lang_service_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_service_name]" onkeyup="service_<?php echo $lang['languages_code'];?>()" />
...
<script type="text/javascript">
    function service_vn () {
        ...
        title = document.getElementById("service_name_vn").value;
    ...
    function service_en () {
        ...
        //alert ("a");
        //Lấy text từ thẻ input title 
        title = document.getElementById("service_name_en").value;
        // document.getElementById('title_seo').value = title;
        //Đổi chữ hoa thành chữ thường
        slug = title.toLowerCase();
