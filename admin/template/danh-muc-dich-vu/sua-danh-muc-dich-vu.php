                            ...
                            <?php 
                                ...
                                ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="text" class="txtNCP1" value="<?= $rowDetailLang['lang_servicecat_name'];?>" name="lang[<?= $lang['languages_code']?>][lang_servicecat_name]" id="servicecat_name_<?= $lang['languages_code']?>" onkeyup="servicecat_<?= $lang['languages_code']?>()" />
...
<form action="" method="post" accept-charset="utf-8" id="updateServiceCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" id="title" onchange="ChangeToSlug()" value="<?= $row_showMain['lang_servicecat_name'];?>" name="servicecat_name"/>
           ...
           <input type="number" name="servicecat_sort_order" value="<?= $row['servicecat_sort_order'] ?>">
...
<script type="text/javascript">
    function servicecat_vn () {
        // alert('vn');
        var title, slug;
        //alert ("a");
        //Lấy text từ thẻ input title 
        title = document.getElementById("servicecat_name_vn").value;
    ...
    function servicecat_en () {
        // alert('en');
        var title, slug;
        //alert ("a");
        //Lấy text từ thẻ input title 
        title = document.getElementById("servicecat_name_en").value;
        // document.getElementById('title_seo').value = title;
        //Đổi chữ hoa thành chữ thường
        slug = title.toLowerCase();
